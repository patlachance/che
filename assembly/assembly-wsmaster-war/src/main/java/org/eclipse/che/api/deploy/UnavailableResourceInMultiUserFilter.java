 ...
 * in multi-user Che.
 *
 * <p>To exclude certain HTTP methods, use FilterConfig init parameter to define such methods
 */
@Singleton
public class UnavailableResourceInMultiUserFilter implements Filter {
  private static final String ERROR_RESPONSE_JSON_MESSAGE =
      "{\"error\" : \"This resource is unavailable in multi-user Che\" }";
  private String[] excludedMethods;

  @Override
  public void init(FilterConfig filterConfig) throws ServletException {
    excludedMethods = filterConfig.getInitParameter("excludedMethods").split(",");
  }
